...
class SearchImages < RequestBase
	...
	QUERY_PARAMS_NAMES = ["phrase","editorial_segments","graphical_styles","license_models","orientations","exclude_nudity","embed_content_only","page","page_size","collection_codes","collections_filter_type"]
